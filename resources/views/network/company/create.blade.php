...
@section('content')
	...
	<div class="page-title">
		<div class="title_left">
			<h3>Gestione Rete <small><i class="fa fa-angle-right"></i> Crea Company</small></h3>
		</div>
		<hr />
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<form id="form_create_company" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('company_insert') }}" method="post">
				{{ csrf_field() }}
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="vat_number" name="vat_number" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select multiple="multiple" class="form-control col-md-7 col-xs-12" id="accounts_id" name="accounts_id[]" required="">
									<?php foreach($accounts as $account): ?>
										<option value="<?= $account->id; ?>"><?= $account->name; ?> <?= $account->surname; ?> (<?= $account->email; ?>)</option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
