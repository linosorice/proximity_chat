...
@section('content')
	...
	<div class="page-title">
		<div class="title_left">
			<h3>Gestione Rete <small><i class="fa fa-angle-right"></i> Crea Store</small></h3>
		</div>
		<hr />
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<form enctype="multipart/form-data" id="form_create_store" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('store_insert') }}" method="post">
				{{ csrf_field() }}
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea id="description" name="description" class="form-control col-md-7 col-xs-12" rows="3" placeholder=""></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="zip_code" name="zip_code" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_facebook" name="profile_facebook" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Twitter</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_twitter" name="profile_twitter" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">YouTube</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_youtube" name="profile_youtube" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Instagram</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_instagram" name="profile_instagram" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Linkedin</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_linkedin" name="profile_linkedin" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Pinterest</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_pinterest" name="profile_pinterest" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tripadvisor</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="profile_tripadvisor" name="profile_tripadvisor" class="form-control col-md-7 col-xs-12">
							</div>
						</div>
					</div>
				</div>
				...
				<input type="hidden" name="company_id" id="company_id" value="<?= $company_data->id; ?>" />
			</form>
